...
var accounts = [];
var getFakeMail = function (fakePerson) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            page.goto(FAKE_MAIL_URL, { waitUntil: "networkidle2" }),
          ];
        case 3:
          _a.sent();
        ...
        case 16:
          ...
          return [
            4 /*yield*/,
            birthdayDay === null || birthdayDay === void 0
              ? void 0
              : birthdayDay.type(userData.birthdayDay),
          ];
        case 17:
          _a.sent();
          return [
            4 /*yield*/,
            month === null || month === void 0 ? void 0 : month.click(),
          ];
        case 18:
          _a.sent();
          return [
        ...
        case 19:
          ...
          return [
            4 /*yield*/,
            rePassword === null || rePassword === void 0
              ? void 0
              : rePassword.type(userData.password),
          ];
        case 20:
          _a.sent();
          return [
        ...
        case 22:
          ...
          return [
            4 /*yield*/,
            regulamin === null || regulamin === void 0
              ? void 0
              : regulamin.click(),
          ];
        case 23:
        ...
        case 25:
          ...
          return [
            4 /*yield*/,
            monthJanuary === null || monthJanuary === void 0
              ? void 0
              : monthJanuary.click(),
          ];
        case 26:
        ...
        case 29:
          ...
          return [
            4 /*yield*/,
            birthdayYear === null || birthdayYear === void 0
              ? void 0
              : birthdayYear.type(userData.birthdayYear),
          ];
        case 30:
          _a.sent();
        ...
        case 33:
          ...
          return [
            4 /*yield*/,
            page.$eval("#login", function (input) {
              return input.value;
            }),
          ];
        case 34:
